...
HD_PWD='C:/Users/sienp/Documents/school/IIW4/Thesis/Thesis/VHDL/felics/felics.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FELICS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FELICS.tcl
