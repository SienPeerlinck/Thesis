...
from py_felics.adjusted_bin_code import AdjustedBinCode
from py_felics.subexponential_code import SubexponentialCode
from py_felics.golomb_rice_code import RiceCode
            ...
            for x in range(width):
                ...
                if l <= p <= h:
                    ...
                    if p < l:
                        ...
                        bs.push_bits(1, 1)
                        e = p - h - 1
                    out_of_range_code.push(e, delta)
        bs.flush()
        # ctx.print_cntrs()
        # ctx.plot_curve()
        return bs.get_bytes()
