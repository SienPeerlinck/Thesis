...
import algorithm.felics as felics
from algorithm.felics import Felics
import algorithm.detector_sim as sim
import algorithm.fapec as fapec
from algorithm.fapec import Fapec
...
def benchmark_bkg_level():
    ...
    axs[0].plot(bkg_list, rfapec, label="FAPEC")
...
def benchmark_amplitude():
    ...
    axs[1].plot(ampl_list, rfapec, label="FAPEC")
    axs[1].plot(ampl_list, rfelics, label="FELICS")
    axs[1].set(xlabel="Amplitude", ylabel="compression ratio", title="Amplitude benchmark")
    axs[1].legend()
    print("------------------------------------------------------------")
    print()
...
def benchmark_bits_per_pixel():
    ...
    axs[2].plot(bpp_list, rfapec, label="FAPEC")
    axs[2].plot(bpp_list, rfelics, label="FELICS")
    axs[2].set(xlabel="Bits per pixel", ylabel="compression ratio", title="Bits per pixel benchmark")
    axs[2].legend()
    plt.show()
    print("------------------------------------------------------------")
    print()
