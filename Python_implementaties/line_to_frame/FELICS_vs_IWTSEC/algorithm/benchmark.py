...
def benchmark_bkg_level():
    ...
    plt.title("Background benchmark")
    plt.show()
...
def benchmark_amplitude():
    ...
    axs[1].plot(ampl_list, riwtsec, label="IWTSEC")
...
def benchmark_bits_per_pixel():
    ...
    axs[2].plot(bpp_list, riwtsec, label="IWTSEC")
